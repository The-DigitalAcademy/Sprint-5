function gymApp() {
    ...
    if (fname === '' || gender === '' || age === '' || weight === '' || height === '') {
        ...
        // document.getElementById('display').innerHTML = 'Name: ' + fname + '<br>' +
        //     'Gender: ' + gender + '<br>' +
        //     'Age: ' + age + '<br>' +
        //     'Weight: ' + weight + '<br>' +
        //     'Height: ' + height;
    ...
    document.getElementById('display').innerHTML += '<br>Hi ' + fname + ', Here is your profile:<br>' +
                                                      'Age      : ' + age + '<br>' +
                                                      'Gender   : ' + gender + '<br>' +
                                                      'Weight   : ' + weight + ' KG <br>'+
                                                      'BMI      : ' + bmi.toFixed(1) + 
    ...
    if (age >= 15 && age < 21) { 
        if (gender === 'Male') {
            document.getElementById('display').innerHTML += 'This is an exercise routine tailored specifically for you:<br>' +
